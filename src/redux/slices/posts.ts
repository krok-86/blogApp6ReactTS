...
export const fetchPosts = createAsyncThunk<Post[]>("posts/fetchPosts", async () => {
  ...
  return data as Post[];//fix
});

export const fetchRemovePost = createAsyncThunk<PostData, string, {rejectValue: IRejectValue} >(
...
export const addPost = createAsyncThunk<PostData, Post, {rejectValue: IRejectValue}>(
  "posts/addPost",
...
export const sendUpdatedPost = createAsyncThunk<PostData, IEditPost, {rejectValue: IRejectValue} >(
  "posts/updatePost",
